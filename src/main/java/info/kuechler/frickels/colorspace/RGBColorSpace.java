...
public class RGBColorSpace {
    ...
    public static final RGBColorSpace AdobeRGB1998 = new RGBColorSpace(//
    ...
    public static final RGBColorSpace AppleRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace BestRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace BetaRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace BruceRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace CIERGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace ColorMatchRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace DonRGB4 = new RGBColorSpace(//
    ...
    public static final RGBColorSpace ECIRGBv2 = new RGBColorSpace(//
    ...
    public static final RGBColorSpace EktaSpacePS5 = new RGBColorSpace(//
    ...
    public static final RGBColorSpace NTSCRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace PAL_SECAMRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace ProPhotoRGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace SMPTE_C_RGB = new RGBColorSpace(//
    ...
    public static final RGBColorSpace WideGamutRGB = new RGBColorSpace(//
    ...
    public RGBColorSpace(final XYY xr, final XYY xg, final XYY xb, final Illuminant illuminant, final double gamma,
    ...
    private static XYY Yto1(XYY xyy) {
    ...
    public boolean equals(Object obj) {
        ...
        final RGBColorSpace other = (RGBColorSpace) obj;
